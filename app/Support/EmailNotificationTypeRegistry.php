...
class EmailNotificationTypeRegistry
{
    ...
    'label' => 'Invoice',
    'description' => 'Send an invoice notification and secure payment link when a new unpaid checkout invoice is created.',
    'trigger' => 'Triggered once when a new unpaid initial checkout invoice is created. The email is not sent again when the same unpaid invoice is reused.',
    'merge_tags' => [
        '{{ user_name }}',
        '{{ user_email }}',
        '{{ package_title }}',
