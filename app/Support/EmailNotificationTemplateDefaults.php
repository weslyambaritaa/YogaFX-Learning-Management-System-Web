...
EmailNotificationTypeRegistry::ASSIGNMENT_REVIEW => [
    ...
    'subject_user' => 'YogaFX invoice {invoice_number}: {package_title}',
    'body_user' => implode('', [
        '<p>Hi {user_name},</p>',
        '<p>Your YogaFX invoice has been created for <strong>{package_title}</strong> ({access_tier_label}).</p>',
        '<p>Invoice number: <strong>{invoice_number}</strong></p>',
        '<p>Amount due: <strong>{currency_code} {amount}</strong></p>',
        '<p>You can securely complete your payment using the link below:</p>',
        '<p><a href="{payment_link_url}">{payment_link_url}</a></p>',
        '<p>Your registration details have been saved, so you do not need to complete the form again.</p>',
        '<p>If you have already completed this payment, you can safely ignore this email.</p>',
    ]),
    'auto_enable' => true,
],
