...
class AccommodationPaymentSubscription extends Model
{
    ...
    public function accommodationBooking(): BelongsTo
    {
        return $this->belongsTo(AccommodationBooking::class);
    }

    public function events(): HasMany
    {
        return $this->hasMany(AccommodationPaymentSubscriptionEvent::class);
    }
}
