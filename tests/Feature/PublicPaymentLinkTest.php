...
class PublicPaymentLinkTest extends TestCase
{
    ...
    public function test_public_scoreboard_submission_can_return_embedded_checkout_payload(): void
    {
        ...
        $response
            ...
            ->assertJsonPath('checkout.first_name', 'Lina')
            ->assertJsonPath('checkout.last_name', 'West')
            ->assertJsonPath('checkout.email', 'lina@example.com')
            ->assertJsonPath('checkout.phone', '+62 81234567000')
            ->assertJsonPath('checkout.country', 'Indonesia')
    ...
    public function test_direct_package_link_submission_returns_checkout_payload_for_locked_package(): void
    {
        ...
        $response
            ...
            ->assertJsonPath('checkout.first_name', 'Ayla')
            ->assertJsonPath('checkout.last_name', 'River')
            ->assertJsonPath('checkout.email', 'ayla@example.com')
            ->assertJsonPath('checkout.phone', '+62 81234567890')
            ->assertJsonPath('checkout.country', 'Indonesia')
