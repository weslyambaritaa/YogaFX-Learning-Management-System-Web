...
1. Buka public page package aktif.
2. Lanjutkan ke checkout signed URL.
3. Verifikasi checkout menampilkan:
   - opsi `Pay in full`
   ...
   - final due date 15 Januari
4. Verifikasi package yang `installment_enabled = false` hanya menampilkan full payment.
