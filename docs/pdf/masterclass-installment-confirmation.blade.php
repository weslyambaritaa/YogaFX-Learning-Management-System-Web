...
<head>
    ...
    <style>
        ...
        .title { text-align: center; margin-bottom: 4px; font-size: 54px; font-weight: 900; letter-spacing: 0.3px; line-height: 1; }
        .title .black { color: #111827; }
...
<body>
    ...
    <div class="page">
        ...
        <div class="content">
            ...
            <p class="intro">We are thrilled that you will be joining us for our RYT 200 YTTC.</p>
