                    ...
                    <div>
                        ...
                        <div className="mt-4 space-y-3">
                            {[
                                ...
                                <p key={item} className="text-sm leading-6 text-white/70">
                                    {item}
                                </p>
                            ))}
                        </div>
        ...
        >
            ...
            <form id="scoreboard-form" onSubmit={submit} className="space-y-6">
                <div className="grid gap-5 md:grid-cols-2">
                    <div>
                        <InputLabel htmlFor="first_name" value="First Name" className="text-white/80" />
                        <TextInput
                            id="first_name"
                            ...
                            required
                        />
                        <InputError className="mt-2 text-red-400" message={errors.first_name} />
                    </div>

                    <div>
                        <InputLabel htmlFor="last_name" value="Last Name" className="text-white/80" />
                        <TextInput
                            id="last_name"
                            ...
                            required
                        />
                        <InputError className="mt-2 text-red-400" message={errors.last_name} />
                    </div>
                    ...
                    <div>
                        <InputLabel htmlFor="phone_number" value="Mobile Phone" className="text-white/80" />
                        ...
                        <InputError className="mt-2 text-red-400" message={errors.phone_number ?? errors.phone_country_code ?? errors.phone} />
                    </div>

                    <div>
                        <InputLabel htmlFor="country" value="Country" className="text-white/80" />
                        <select
                            id="country"
                            value={data.country}
                            ...
                            required
                        >
                            <option value="" className="bg-gray-900 text-white">Select a country</option>
                        ...
                        <InputError className="mt-2 text-red-400" message={errors.country} />
                    </div>

                    <div>
                        <InputLabel htmlFor="access_tier_id" value="Program / Tier" className="text-white/80" />
                        <select
                            id="access_tier_id"
                        ...
                        <InputError className="mt-2 text-red-400" message={errors.access_tier_id} />
                    </div>
                </div>
            </form>
        </PublicFlowLayout>
