...
function EnrollmentSuccessLoadingOverlay({ secondsRemaining }) {
    return (
        <div
            ...
            role="status"
            aria-live="polite"
            aria-label={`Enrollment success page will open in ${secondsRemaining} seconds`}
        >
            <div
                aria-hidden="true"
...
export default function EnrollmentSuccess({ onboarding, student = null }) {
    ...
    return (
        <>
                    ...
                    >
                        <div className="w-full max-w-2xl text-center">
                            ...
                            <h2 className="mt-10 text-3xl font-bold leading-tight text-white md:text-4xl">
                                Your Enrollment Application Is Approved.
                            </h2>
            ...
            {isLoading ? (
                <EnrollmentSuccessLoadingOverlay
