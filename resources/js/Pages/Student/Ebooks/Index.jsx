                ...
                <section className="space-y-5">
                    ...
                    <div className="grid gap-5 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
                        {ebooks.map((ebook, index) => (
                            <article
                                key={ebook.id}
                                className="group flex flex-col overflow-hidden rounded-[14px] border border-white/10 bg-white/[0.04] transition duration-300 hover:-translate-y-1 hover:border-white/20 hover:bg-white/[0.06]"
                            >
                                <div className="relative overflow-hidden p-5 pb-0">
                                    <div
                                        className={[
                                            'relative aspect-[3/4] rounded-[12px] border border-white/10 p-5 shadow-[0_18px_45px_rgba(0,0,0,0.3)]',
                                            index % 4 === 0
                                    ...
                                    >
                                        <div className="flex h-full flex-col justify-between">
                                            <div className="inline-flex w-fit items-center gap-2 rounded-md border border-white/12 bg-black/25 px-3 py-1 text-[11px] uppercase tracking-[0.22em] text-white/70 backdrop-blur">
                                ...
                                <div className="flex flex-1 flex-col justify-between gap-4 p-5">
                                    ...
                                    <Button
                                        asChild
                                        className="rounded-lg bg-[#f15b3a] text-white hover:bg-[#ff6a49]"
                                    >
