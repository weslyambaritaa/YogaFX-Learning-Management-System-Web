        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/80 backdrop-blur-sm px-4">
            <div className="relative w-full max-w-md rounded-[28px] border border-white/15 bg-[#1a1210] p-8 shadow-2xl">
                ...
                <div className="space-y-3 text-center">
                    ...
                    <p className="text-sm leading-7 text-white/55 max-w-sm mx-auto">
                        {current.body}
                    </p>
                </div>
...
function LessonRow({ lesson }) {
    ...
    const content = (
        <div className="flex items-center gap-3 rounded-[6px] border border-white/8 bg-white/[0.03] px-4 py-3 hover:bg-white/[0.06] transition">
            ...
            {isCompleted && (
                <span className="text-[10px] uppercase tracking-[0.18em] text-emerald-400/70 shrink-0">
                    Done
                </span>
            )}
                        ...
                        <div className="space-y-1.5">
                            <div className="flex justify-between text-[11px] uppercase tracking-[0.18em] text-white/40">
                                <span>
                                    ...
                                    {module.lesson_count} lessons done
                                </span>
                ...
                {module.show_progress && (
                    <div className="h-[3px] rounded-[2px] bg-white/10 overflow-hidden">
                        <div
                            className={[
                                "h-full rounded-[2px]",
                                isCompleted ? "bg-emerald-400" : "bg-[#DB202C]",
                            ].join(" ")}
...
function ModuleRow({ title, modules, onCardClick }) {
    ...
    const scroll = (d) =>
        ref.current?.scrollBy({ left: d * 290, behavior: "smooth" });
...
function HeroSection({
    ...
    const ctaLabel =
        ...
        (isNew ? "Start First Lesson" : "Continue Learning");
    const ctaUrl =
        ...
        <section className="relative min-h-[72vh] sm:min-h-[82vh] flex items-end overflow-hidden">
            ...
            <div className="relative w-full px-4 pb-16 pt-24 sm:px-6 lg:px-10 lg:pb-24 max-w-[1400px] mx-auto">
                <div className="max-w-2xl space-y-5">
                    ...
                    {description && (
                        <p className="text-sm leading-7 text-white/65 sm:text-[15px] max-w-xl">
                            {description}
                        </p>
                    )}
    ...
    return (
        ...
        >
            ...
            <HeroSection
                ...
                onInfoClick={
                    heroModule ? () => setSelectedModule(heroModule) : null
                }
