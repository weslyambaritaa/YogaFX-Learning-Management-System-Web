...
function FlashMessage({ status, errors }) {
    if (['lesson-created', 'lesson-updated', 'lesson-deleted'].includes(status)) {
        const msg = {
            'lesson-created': 'Lesson has been created.',
            'lesson-updated': 'Lesson has been updated.',
            'lesson-deleted': 'Lesson has been deleted.',
        };
        return (
                    ...
                    <div className="overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-sm">
                        ...
                        <div className="flex flex-col gap-3 border-b border-slate-100 px-5 py-4 sm:flex-row sm:items-center sm:justify-between">
                            <div className="flex items-center gap-2.5">
                                ...
                                <span className="text-sm font-semibold text-slate-700">Lesson List</span>
                                    ...
                                    {paginated.length === 0 ? (
                                        ...
                                        paginated.map((lesson) => (
                                            <tr key={lesson.id} className="hover:bg-slate-50/70 transition-colors align-top">
                                                ...
                                                <td className="px-4 py-4">
                                                    <div className="flex items-center gap-4">
                                                        {lesson.thumbnail_url ? (
                                                            ...
                                                            <div className="flex h-14 w-20 shrink-0 items-center justify-center rounded-md bg-gray-100 text-[11px] font-medium uppercase tracking-wide text-gray-500">
                                                                No image
                                                            </div>
                                                        )}
                                                ...
                                                <td className="px-4 py-4 text-gray-700 align-top whitespace-nowrap">{lesson.scoreboard ?? 'None'}</td>
