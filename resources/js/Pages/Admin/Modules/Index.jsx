                            ...
                            <table className="min-w-full text-sm">
                                ...
                                <thead>
                                    <tr className="bg-gray-900 text-white">
                                        <th className="px-4 py-3 text-left text-xs font-semibold uppercase tracking-wide">Module</th>
                                        <th className="px-4 py-3 text-left text-xs font-semibold uppercase tracking-wide">Tiers</th>
                                        <th className="px-4 py-3 text-left text-xs font-semibold uppercase tracking-wide">Order</th>
                                        <th className="px-4 py-3 text-left text-xs font-semibold uppercase tracking-wide">Lessons</th>
                                        ...
                                        paginated.map((module, idx) => (
                                            <tr key={module.id} className="hover:bg-gray-50">
                                                ...
                                                <td className="px-4 py-3">
                                                    <div className="flex items-center gap-3">
                                                        ...
                                                        <div>
                                                            ...
                                                            {module.url_slug && (
                                                                <div className="text-xs text-gray-400">{module.url_slug}</div>
                                                            )}
                                                        </div>
                                                    </div>
                                                </td>
                                                ...
                                                <td className="px-4 py-3 text-gray-500">
                                                    {module.order ?? (safePage - 1) * pageSize + idx + 1}
                                                </td>
                                                {/* Lessons count */}
                                                <td className="px-4 py-3 text-gray-500">
                                                    {module.lessons_count ?? module.lessons?.length ?? '—'}
                                                </td>
                                                <td className="px-4 py-3">
                                                    <div className="flex items-center gap-3">
                                                        <Link
