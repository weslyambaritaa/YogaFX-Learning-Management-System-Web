...
<body>
    ...
    <div class="page">
        ...
        <div class="content">
            ...
            <p class="closing">
                Thank you for your interest in Yoga<span style="color:red"><span style="color: red;">FX</span></span> International Yoga Teacher Training Academy<br>it really is appreciated.
            </p>
        ...
        <div class="footer">
            ...
            @endif
            <div class="copyright">Copyright &copy; {{ date('Y') }} Yoga<span style="color:red"><span style="color: red;">FX</span></span> International Yoga Teacher Training Academy</div>
